...
public class WebTableOrder_Step_Definitions {
...
//we need to create Select class obj because this one class more dropdown option.
...
// we store the card type element as a list that's why we need to use foreach loop.
